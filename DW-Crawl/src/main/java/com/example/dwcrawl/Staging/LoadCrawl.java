...
//        }
        ...
        process_status_stmt1.setString(4, "Đang tiến hành tiến trình 3");
        ...
        process_status_stmt2.setInt(1, 3);
        ...
        try (CSVReader reader = new CSVReader(new FileReader(csvFile))) {
            ...
            PreparedStatement truncDetail = conn1.prepareStatement("TRUNCATE TABLE stg_gold_price_detail");
            truncDetail.executeUpdate(); // Truncate stg_gold_price_detail
            trunc_stmt.executeUpdate(); // Truncate stg_gold_price_source
            ...
            // 9. Đọc dữ liệu từ  giavang_ddmmYYYY.csv và lưu vào DB staging
            ...
            success_status_stmt1.setString(4, "Hoàn thành tiến trình 3");
            ...
            success_status_stmt2.setInt(1, 3);
        ...
        // Ghi log vào DB control đọc dữ liệu từ file giavang_ddmmYYYY.csv ko thành công
            ...
            input_file_error_stmt1.setInt(1, 3);
